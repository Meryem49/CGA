...
abstract public class GameWindow
{
    ...
    private void initialize()
    {
        ...
        glfwSetErrorCallback(new GLFWErrorCallback()
        {
            ...
            {
                System.out.println("OpenGL Error: " + GLFWErrorCallback.getDescription(description));
            }
        });
    ...
    {
        return (float)(m_currentTime * 1e-9);
    }
    ...
    public void run()
    {
        ...
        while(!glfwWindowShouldClose(m_window))
        {
            ...
            {
                update((float)((double)timedelta * 1e-9d), (float)(m_currentTime * 1e-9));
                accum -= timedelta;
            }
            render((float)((double)frametime * 1e-9d), (float)(m_currentTime * 1e-9));
    ...
    private void initImGui()
    {
        ...
        atlas.addFontFromFileTTF("./project/assets/Fonts/Scream_Real.ttf", 150);
    ...
    public void renderImGuiContent()
    {
        ...
        ImGui.setWindowPos("scoreText",200,0);
        ImGui.text("100");
        ImGui.end();
